...
export function NavRight({handleConvert,setRightOpen,isRightOpen,setLeftOpen}){
    ...
    <>
        ...
        <aside className={`min-[55px]:flex lg:hidden flex-col w-auto h-screen   overflow-y-auto bg-slate-50 justify-center `}>
            ...
            <div className="">
            <IoMdArrowDropleft  className={`text-slate-900 text-3xl ${isRightOpen?"rotate-180":""}`} onClick={()=>{setRightOpen((i)=>!i); setLeftOpen(false)}}/>
            </div>
