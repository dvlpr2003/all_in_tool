            ...
            <div className="flex flex-col justify-center w-full">
                <ul className="flex flex-col justify-evenly ">
                    <li className="flex flex-col border-b border-black " >
                        ...
                        <IoIosArrowDropdownCircle  className={`text-xl cursor-pointer ${fromPdf?"rotate-180":"rotate-0"} transition-all`} />
                        </div>
                        </div>
                    ...
                    <div className="flex items-end pb-2 h-14" onClick={()=>setToPdf((e)=>!e)}>
                        ...
                        <div className="ml-auto justify-end pr-3">
                        <IoIosArrowDropdownCircle className={`text-xl cursor-pointer ${toPdf?"rotate-180":"rotate-0"} transition-all`} />
                        </div>
                        </div>
                    ...
                    <li className="border-b border-black " >
                        <div className="flex items-end pb-2 h-14" onClick={()=>setOrganize(e=>!e)}>
                            ...
                            <div className="ml-auto justify-end pr-3">
                            <IoIosArrowDropdownCircle className={`text-xl cursor-pointer ${Organize?"rotate-180":"rotate-0"} transition-all`} />
                            </div>
                        </div>
                    ...
                    <li className="border-b border-black " >
                        <div className="flex items-end pb-2 h-14" onClick={()=>setEdit(e=>!e)}>
                                ...
                                <div className="ml-auto justify-end pr-3">
                                <IoIosArrowDropdownCircle className={`text-xl cursor-pointer ${Edit?"rotate-180":"rotate-0"} transition-all`} />
                                </div>
                        </div>
