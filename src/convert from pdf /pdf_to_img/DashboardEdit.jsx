...
import { removeFromJPGItem } from "./pdftojpgSlicer";
    ...
    return(
        ...
        {JPGItems.map((e)=>
            ...
            <div className="border bg-white  w-44 h-52 p-9 shadow-lg group relative">
                <JPGDelete globDispatch = {globDispatch}  id = {e.id}/>
...
function JPGDelete({globDispatch,id}){
    function handleEvent(){
        
        globDispatch(removeFromJPGItem(id))
